...
// const zoot = document.getElementById('portfolio'); let OpenProject = document.querySelector(".See-project")

// zoot.innerHTML += `
// <section class="Second_Works">
// <div class="Tonic">
//   <img src="picture/Snapshoot Portfolio (1).png" alt="" class="mobile-img">
//   <img src="picture/Snapshoot Portfolio (3).png" alt="" class="desktop-img">
// </div>
// <h2>${projectDetails[1].name}</h2>
// <div class="canopy">
//   <ul>
//     <li class="First-line">CANOPY</li>
//     <li class="Desktop-first-line">FACEBOOK</li>
//     <li>Back End Dev</li>
//     <li>2015</li>
//   </ul>
// </div>
...
// let OpenProject = document.querySelector(".See-project")
// let fulSection = document.querySelector(".works-card")
// // let Closed = document.querySelector("#close-me")

// OpenProject.onclick = function(){
//     fulSection.classList.add("openMe")
//     OpenProject.classList.add("displayMe")
//     console.log("aers")
// }

// // Closed.onclick = function(){
// //     this.parentElement.classList.remove("openMe")
// //     OpenProject.classList.remove("displayMe")
// // }
// const Closeded= document.getElementById('close-me');
// Closeded.addEventListener('click', function() {
//     // this.parentElement.parentElement.classList.remove("openMe")
//     fulSection.classList.remove("openMe")
//     OpenProject.classList.remove("displayMe")
